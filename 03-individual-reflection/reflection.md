...
| Problem Card | Phản biện cách mô tả actor, workflow, bottleneck và AI hypothesis cho các card. | Giúp tôi nhìn rõ success metric và human boundary của Card PDF. | AI không tự biết rủi ro bản quyền, OCR sai công thức hoặc lỗi LaTeX có thể khó phát hiện. | Tôi bổ sung câu hỏi challenge về công thức sai, chi phí API và yêu cầu giữ ảnh/link PDF để đối chiếu. |
